(function() {
  ...
  describe("service githubContributor", function() {
    ...
    beforeEach(module("websocketLoadTester"));
    beforeEach(
      inject(function(_githubContributor_, _$httpBackend_, _$log_) {
    ...
    describe("getContributors function", function() {
      ...
      it("should return data", function() {
        $httpBackend
          .when("GET", githubContributor.apiHost + "/contributors?per_page=1")
          .respond(200, [{ pprt: "value" }]);
        var data;
      ...
      it("should define a limit per page as default value", function() {
        $httpBackend
          .when("GET", githubContributor.apiHost + "/contributors?per_page=30")
